...
CREATE INDEX IF NOT EXISTS idx_filesystem_session ON filesystem(session_id);
CREATE INDEX IF NOT EXISTS idx_filesystem_path ON filesystem(path);
...
CREATE INDEX IF NOT EXISTS idx_history_seq ON command_history(session_id, sequence_number);
...
CREATE INDEX IF NOT EXISTS idx_attack_session ON attack_techniques(session_id);
CREATE INDEX IF NOT EXISTS idx_attack_technique ON attack_techniques(technique_id);
