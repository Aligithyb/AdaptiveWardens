...
class SandboxDatabase:
    ...
    def _init_default_filesystem(self, conn, session_id: str):
        ...
        canary_aws_key    = os.getenv('CANARY_AWS_ACCESS_KEY')    or 'AKIAVLQNEXOPAY1PROD7'  # nosemgrep
    ...
    def _init_default_environment(self, conn, session_id: str):
        ...
        canary_aws_key    = os.getenv('CANARY_AWS_ACCESS_KEY',    'AKIAVLQNEXOPAY1PROD7')  # nosemgrep
