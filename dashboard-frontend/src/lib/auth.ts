...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  admin:       ['dashboard', 'live-sessions', 'attack-map', 'ioc-summary', 'mitre-attack', 'metrics', 'reports', 'threat-intelligence'],
  soc_analyst: ['dashboard', 'live-sessions', 'ioc-summary', 'mitre-attack', 'attack-map', 'reports'],
  it_staff:    ['dashboard', 'live-sessions', 'metrics'],
